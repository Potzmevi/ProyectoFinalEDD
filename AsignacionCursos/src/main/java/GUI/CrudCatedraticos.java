 ...
 * @author meza4
 */
public class CrudCatedraticos extends javax.swing.JFrame {

    /**
     * Creates new form MenuPrincipal
     */
    public CrudCatedraticos() {
        initComponents();
        setVisible(true);
        pack();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Crear Catedratico");
        ...
        jButton7.setText("Modificar Catedratico");
        ...
        jButton10.setText("Eliminar Catedratico");
        ...
        jPanel1.add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 260, 210, 40));

        jLabel3.setFont(new java.awt.Font("Consolas", 1, 27)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("CRUD Catedratico");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrudCatedraticos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrudCatedraticos().setVisible(true);
            }
        });
    }
