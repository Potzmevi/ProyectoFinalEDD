...
public class EliminarCurso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Eliminar Curso");
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        try {
            if (!id.getText().equals("")) {
                Nodo nodo = listaCursos.buscarId(Integer.valueOf(id.getText()));
                if (nodo == null) {
                    JOptionPane.showMessageDialog(null, "Curso con ese id no existe");
                } else {
                    listaCursos.delete(id.getText());
