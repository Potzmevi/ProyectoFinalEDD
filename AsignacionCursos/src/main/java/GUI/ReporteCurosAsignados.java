 ...
 * @author meza4
 */
public class ReporteCurosAsignados extends javax.swing.JFrame {

    /**
     * Creates new form MenuPrincipal
     */
    public ReporteCurosAsignados() {
        initComponents();
        setVisible(true);
        pack();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ver Asignaciones");
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Curso", "Hora", "Dia", "Edificio", "Salon", "Catedratico", "Zona", "Examen Final", "Nota Total"
            }
        ));
        ...
        carnet.setBackground(new java.awt.Color(255, 255, 204));
        carnet.setForeground(new java.awt.Color(0, 0, 0));
        carnet.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        jPanel1.add(carnet, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 160, 230, -1));
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        try {
            if (!id.getText().equals("")) {
                Estudiante estu = estudiantes.get(Integer.valueOf(carnet.getText()));
                if (estu == null) {
                    JOptionPane.showMessageDialog(null, "Estudiante con ese carnet no existe");
                } else {

                    ArrayList asignaciones = Main.listaAsignaciones.obtenerAsignacionesEstudiante(estu.getCarnet());
                ...
                JOptionPane.showMessageDialog(null, "Por favor ingrese un Carnet");
            }
        } catch (Exception e) {
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteCurosAsignados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReporteCurosAsignados().setVisible(true);
            }
        });
    }
