...
public class ModificarUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipo.setFont(new java.awt.Font("Consolas", 0, 13)); // NOI18N
        ...
        try {
            ...
            if (!usuario.getText().equals("") && !password.getText().equals("") && !tipo.getText().equals("")) {
               ...
               this.dispose();
                ...
                JOptionPane.showMessageDialog(null, "Por favor ingrese el nuevo user y password");
            }
        } catch (Exception e) {
        }
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        try {
            if (!id.getText().equals("")) {
                ...
                if (nodo == null) {
                    JOptionPane.showMessageDialog(null, "Usuario con ese id no existe");
                } else {
                    jButton12.setEnabled(true);
                    id.setEditable(false);
                    Usuario user = (Usuario) nodo.getData();
                    usuario.setText(user.getNombre());
                    password.setText(user.getPassword());
                    tipo.setText(user.getTipo());
                }
