...
public class ModificarCurso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modificar Curso");
        ...
        try {
            ...
            if (!codigo.getText().equals("") && !nombre.getText().equals("") && !semestre.getText().equals("") && !creditos.getText().equals("")) {
               ...
               this.dispose();
                ...
                JOptionPane.showMessageDialog(null, "Por favor ingrese los nuevos campos");
            }
        } catch (Exception e) {
        }
        ...
        try {
            if (!codigo.getText().equals("")) {
                ...
                if (nodo == null) {
                    ...
                    Curso curso = (Curso) nodo.getData();
                    nombre.setText(curso.getNombre());
                    semestre.setText(String.valueOf(curso.getSemestre()));
