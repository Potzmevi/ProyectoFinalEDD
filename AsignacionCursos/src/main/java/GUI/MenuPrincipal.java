...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 230, 160, 40));
        ...
        jPanel1.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 230, 190, 40));
        ...
        jPanel1.add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 290, 160, 40));
        ...
        jPanel1.add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 350, 160, 40));
        ...
        jPanel1.add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 290, 190, 40));
        ...
        jMenuItem4.setText("Edificios/Salones");
        ...
        jMenuItem7.setText("Asignaciones");
        ...
        jMenuItem5.setText("Cursos Asignados");
        ...
        jMenuItem9.setText("Estudiantes por Curso");
        ...
        jMenuItem10.setText("Cursos por Salon");
        ...
        jMenuItem11.setText("Aprobados por Semestre");
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                Controlador.cargarArchivos(cadena);
            } catch (Exception e) {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Usuarios Graficados con exito");
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        try {
            ...
            Graphviz.graficarTabla(datos);
             JOptionPane.showMessageDialog(null, "Estudiantes Graficados con exito");
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
         try {
            catedraticos.crearGrafica();
             JOptionPane.showMessageDialog(null, "Catedraticos Graficados con exito");
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
         try {
            listaEdificios.graficarListaCircular();
             JOptionPane.showMessageDialog(null, "Edificios Graficados con exito");
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
       ...
       try {
           ...
           JOptionPane.showMessageDialog(null, "Horarios Graficados con exito");
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        try {
           ...
           JOptionPane.showMessageDialog(null, "Asignaciones Graficadas con exito");
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        try {
           ...
           JOptionPane.showMessageDialog(null, "Cursos Graficados con exito");
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
       new ReporteCurosAsignados();
    }//GEN-LAST:event_jMenuItem5ActionPerformed

    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        new ReporteEstudiantesCurso();
    }//GEN-LAST:event_jMenuItem9ActionPerformed

    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
        new ReporteCursosSalon();
    }//GEN-LAST:event_jMenuItem10ActionPerformed

    private void jMenuItem11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem11ActionPerformed
       new ReporteEstudiantesAprobados();
