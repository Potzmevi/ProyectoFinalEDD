...
public class CrearCurso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        creditos = new javax.swing.JFormattedTextField();
        ...
        nombre.setFont(new java.awt.Font("Consolas", 0, 13)); // NOI18N
        ...
        creditos.setBackground(new java.awt.Color(255, 255, 204));
        creditos.setForeground(new java.awt.Color(0, 0, 0));
        creditos.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel6)
                    .addComponent(nombre, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel4, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(14, 14, 14)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(semestre, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(14, 14, 14)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        try {
            if (!codigo.getText().equals("") && !nombre.getText().equals("") && !semestre.getText().equals("") && !creditos.getText().equals("")) {
                Nodo nodo = listaCursos.buscarId(Integer.valueOf(codigo.getText()));
                if (nodo == null) {
                    listaCursos.add(new Curso(Integer.valueOf(codigo.getText()), nombre.getText(), Integer.valueOf(semestre.getText()), Integer.valueOf(creditos.getText())));
                    JOptionPane.showMessageDialog(null, "Curso " + nombre.getText() + " creado con exito");
                    this.dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Curso con ese codigo ya existe por favor ingrese otro");
                }
            } else {
    ...
    private javax.swing.JFormattedTextField creditos;
